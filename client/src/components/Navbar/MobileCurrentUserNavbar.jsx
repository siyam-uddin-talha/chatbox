                ...
                <AppBar position="static" className='APP_BAR' style={{
                    ...
                    <Toolbar>
                        <Box className='mobile_navigate_to_messenger' >
                            <IconButton className='__BTN_NA' onClick={() => navigate("/messages/r")} size='small' >
                                <ArrowBackOutlinedIcon />
                            </IconButton>
                        </Box>
                        <Box className='mobile_navigate_friends_avater' sx={{ ml: 2 }} >
                            <Avatar alt={`${data.conversationFriend.firstName} ${data.conversationFriend.lastName}`} src={data.conversationFriend.photoUrl} className='friend_avater' />
                        </Box>
            ...
            <AppBar position="static" className='APP_BAR' style={{
                ...
                <Toolbar>
                    ...
                    <Box className='mobile_navigate_friends_avater' sx={{ mx: 2 }} >
                        <Skeleton variant="circular" width={40} height={40} sx={{ background: "rgb(40 59 78)" }} />
                    </Box>
                    ...
                    <Typography
                        ...
                        component="div"
                    >
                        <Skeleton variant="text" width={100} height={40} sx={{ background: "rgb(36 55 74)" }} />
                    </Typography>
